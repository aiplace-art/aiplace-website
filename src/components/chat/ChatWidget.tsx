...
const ChatWidget: React.FC<ChatWidgetProps> = ({
  ...
  useEffect(() => {
    ...
    if (chatState.messages.length === 0) {
      const welcomeMessage: Message = {
        id: '1',
        content: "Hi! I'm your AI assistant for AiPlace. How can I help you today?",
        sender: 'assistant',
        timestamp: new Date()
      };
  ...
  const getDefaultResponse = async (message: string): Promise<string> => {
    ...
    if (lowerMessage.includes('service') || lowerMessage.includes('help')) {
      return "I can help you with our AI automation services, web development, mobile apps, and more. Would you like to learn about a specific service?";
    }
    if (lowerMessage.includes('price') || lowerMessage.includes('cost')) {
      return "Our pricing varies based on project scope. Would you like to schedule a free consultation to discuss your needs?";
    }
    if (lowerMessage.includes('contact') || lowerMessage.includes('book')) {
      return "I'd be happy to help you get in touch with our team. Please share your contact details and I'll have someone reach out to you.";
    }

    return "Thank you for your message! Our team will get back to you shortly. Is there anything specific I can help you with?";
  };
